...
DEVLIB2="devlib2-2.11"
MRFIOC2="mrfioc2"
IOCSTATS="iocStats-3.2.0"
PROCSERV="procServ-2.8.0"
...
wget https://github.com/epics-modules/devlib2/archive/refs/tags/2.11.tar.gz -O ${DEVLIB2}.tar.gz
